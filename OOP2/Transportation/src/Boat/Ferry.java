...
public class Ferry extends PublicTransportation{
	 ...
	 */
	public Ferry(double t, int n,int y, String name)
	{
		super(t,n);
		this.buildYear=y;
		this.shipName=name;
	...
	{
		return ("The "+getShipName() +" ferry was built in "+getBuildYear()+", the price of the ticket is "+ ticketPrice + "$ and there are "+ numStops+" stations");
	}
	...
	public boolean equals(Ferry f1)
	{
		...
		{
			return (numStops==f1.numStops && ticketPrice==f1.ticketPrice && getBuildYear()==f1.getBuildYear() && getShipName().equals(f1.getShipName()));
		}
	}
}
